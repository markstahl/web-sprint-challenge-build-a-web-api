...
Like React, Node is acynchronous, dynamic and uses events. Express is used for quickness and ease of access, allowing developers to make endpoints quickly and easily.

2. Understand and explain the use of Middleware?

Middlewares perform actions in an order. Things such as requests, performing an actions, etc.

3. The basic principles of the REST architectural style.

REST basically sets up code so it is unformly distributed between components to keep it neat and organized.

4. Understand and explain the use of Express Routers.

Just as it did with React, it creates routes for api endpoints.

5. Describe tooling used to manually test the correctness of an API.

Since testing an API endpoint in a browser is arduous and unnecessary, applications like Postman make it very easy to test endpoints through CRUD operations and more.
